...
Fail ini menyimpan bentuk-bentuk asas trengkas yang boleh digunakan
untuk tujuan:
- rujukan
- penjanaan feedback yang lebih spesifik
- analisis lanjutan berdasarkan pola gurisan

Buat masa ini ia belum dihubungkan secara penuh dengan AI engine,
tetapi struktur ini sudah bersedia untuk digunakan kemudian.
"""
...
def get_trengkas_pattern(char: str):
    """
    Dapatkan bentuk trengkas standard bagi satu huruf atau gabungan huruf.

    Contoh:
    - get_trengkas_pattern("a")
    - get_trengkas_pattern("ng")
    """
